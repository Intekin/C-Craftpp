...
private:
	...
	void addXBlockToMesh(const sf::Vector2i& textrureCoords, const sf::Vector3i& blockPosition);
	...
	bool shouldMakeFace(const sf::Vector3i& blockPosition, const BlockDataHolder& blockData);
